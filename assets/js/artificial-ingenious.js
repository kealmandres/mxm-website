...
function setupScrollDrivenHeroSlideshow() {
    // The slideshowContainer is now a direct child of body.artificial-ingenious or similar global position
    ...
    // Ensure images are positioned absolutely and initially hidden
    images.forEach(img => {
        ...
        img.style.opacity = '0'; // Start all transparent
    });
